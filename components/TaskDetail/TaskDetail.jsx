      ...
      <div className="p-3 max-h-full flex flex-col gap-5 justify-between">
        <div className="flex justify-between items-center">
          ...
          <p className="text-[#FBBF24] w-fit h-fit text-xs p-1 rounded-md bg-[#FBBF24]/10 border border-[#FBBF24]/40 shadow-[0_0_10px_rgba(251,191,36,0.3)]">
            {userTask.priority.toUpperCase()}
          </p>
        </div>
        <div className="max-h-[35dvh] overflow-y-scroll scrollbar-none ">
          <p className="font-karla text-xs text-justify">
        ...
        <div className="text-[#FBBF24] p-2 rounded-md bg-[#FBBF24]/20 border border-[#FBBF24]/40 shadow-[0_0_10px_rgba(251,191,36,0.3)] flex justify-between items-center font-karla">
          ...
          <span className="text-xs">
            {new Date(userTask.deadline).toLocaleDateString()}
          </span>
        </div>
        <div className="flex flex-col font-karla gap-2 bg-white/10 backdrop-blur-xl shadow-[0_0_2px_rgba(0,0,0,0.5)] p-2 rounded-md">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-extralight text-xs">
              {userTask.isCompleted === false ? "Not Completed" : "Completed"}
            </span>
          </div>
        </div>
        <div className="flex gap-3 font-karla text-xs">
          <div
            className="cursor-pointer flex gap-2 justify-center p-2 rounded-md bg-[#414328]/60 border border-[#D1C373]/40 text-[#E8D985] shadow-[0_0_12px_rgba(209,195,115,0.2),inset_0_1px_1px_rgba(255,255,255,0.25)] items-center grow"
          ...
          <div
            className=" rounded-md p-2 cursor-pointer flex gap-2 justify-center items-center bg-[#4A282D]/70 border border-[#E07A85]/30 text-[#EFA3AC] shadow-[0_0_12px_rgba(224,122,133,0.15),inset_0_1px_1px_rgba(255,255,255,0.25)] grow"
            onClick={() => handleDeleteTask(userTask._id)}
          >
            <Trash2 size={14} />
            <p>Delete Task</p>
          </div>
